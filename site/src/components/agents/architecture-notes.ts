...
export const architectureNotes: Record<string, AgentArchitectureNote> = {
  ...
  "roo-code": {
    ...
    checkedAt: "2026-07-06",
    summary:
      "Roo Code is an archived editor-extension host. Its public repository still documents a rich VS Code agent with modes, MCP servers, custom modes, browser interaction, checkpointing, and task automation, but the 2026 archive status must be visible beside any capability claim.",
    sources: [
      {
        label: "Roo Code repository",
        url: "https://github.com/RooCodeInc/Roo-Code",
      },
      {
        label: "Roo Code docs",
        url: "https://roocodeinc.github.io/Roo-Code-Docs/",
      },
    ],
    sections: [
      {
        title: "Runtime boundary",
        body:
          "The adapter target is the VS Code extension host. VS Code owns activation, webviews, workspace APIs, extension storage, and tool execution prompts; agent-connector can only claim the extension and workspace surfaces it can write or configure.",
        bullets: [
          "The repository was archived and made read-only in May 2026, so the page must mark it as a legacy/source-stable host.",
          "Roo Code described itself as an AI-powered development team in the editor.",
          "The current row should be treated as extension architecture study, not as an actively evolving flagship product.",
        ],
      },
      {
        title: "MCP registration",
        body:
          "MCP servers are a first-class Roo Code feature in the public README and make this row important for extension-host MCP study. The adapter page should keep MCP registration separate from custom modes and editor commands.",
        bullets: [
          "MCP extends Roo Code with external tools and data sources.",
          "The extension context matters because server configuration may live in extension storage or workspace-visible files rather than a CLI dot directory.",
        ],
      },
      {
        title: "Hook bridge",
        body:
          "Roo Code is classified as MCP-only in the current connector matrix. That means the page should not invent lifecycle hook support from its rich extension behavior; editor commands and mode transitions are not the same as a file-authored hook bridge.",
        bullets: [
          "Mode switching is a host UI and prompt behavior.",
          "Any future hook support would need a concrete extension API or generated bridge, not just MCP availability.",
        ],
      },
      {
        title: "Content surfaces",
        body:
          "Roo Code's content model centers on modes such as Code, Architect, Ask, Debug, and Custom. Those modes are useful teaching material because they show how an extension host can expose persona and workflow controls without necessarily exposing subagent files.",
        bullets: [
          "Custom modes should be shown as host-native content, not automatically mapped to agent-connector subagents.",
          "Checkpointing and browser interaction are host capabilities that affect the session loop rather than installation shape.",
        ],
      },
      {
        title: "Marketplace and host-only affordances",
        body:
          "Roo Code's extension distribution and archive status are the important marketplace facts. It should remain in the archive for historical and compatibility study, but the coverage page should not position it like an actively maintained flagship host.",
        bullets: [
          "The archive status changes support expectations even when the source remains inspectable.",
          "Alternatives or forks should be studied as separate hosts if they have different runtime contracts.",
        ],
      },
    ],
    limits: [
      "Roo Code is archived, so current capability claims should be treated as legacy source review rather than active roadmap evidence.",
      "MCP support does not imply lifecycle hook support in this adapter row.",
      "Do not merge Roo Code with Cline or other descendants unless their current extension storage and APIs match.",
    ],
  },
  kilo: {
    status: "researched",
