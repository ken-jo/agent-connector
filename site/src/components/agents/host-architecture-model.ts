...
export const hostArchitectureBriefs: Record<string, string> = {
  ...
  "roo-code":
    "Roo Code is an editor-extension MCP/content host: MCP, slash commands, skills, and memory are writable, while hooks and file-authored subagents are not confirmed native surfaces.",
  kilo:
...
export const hostSourceReviewNotes: Record<string, HostSourceReviewNote> = {
  ...
  "roo-code": {
    checkedAt: "2026-07-06",
    source: "RooCodeInc/Roo-Code repository",
    findings: [
      "Roo Code presents itself as an editor-hosted AI agent team, so the page classifies it as an extension surface rather than a standalone CLI.",
      "The adapter treats MCP, slash-command content, skills, and memory as writable surfaces while keeping hooks and file-authored subagents out unless a native contract is confirmed.",
      "The host's team/delegation UI language is not automatically equivalent to a writable subagent definition folder.",
    ],
  },
  kilo: {
    checkedAt: "2026-07-06",
