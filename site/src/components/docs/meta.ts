...
export const DEFAULT_DESCRIPTION =
  "One declarative defineConnector deploys MCP servers, hooks, commands, skills, subagents & memory (AGENTS.md-first managed blocks) across 32 AI-agent platforms — with default, platform-independent per-tool token telemetry.";
