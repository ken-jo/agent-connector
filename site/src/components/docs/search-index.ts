...
const sectionHeadings: Record<string, { id: string; title: string }[]> = {
  ...
  "ucp-mcp-server": [
    { id: "ucp-what-it-is", title: "Before you start: UCP in MCP terms" },
    { id: "ucp-step-project", title: "1. Create the package" },
    { id: "ucp-step-declare", title: "2. Declare the UCP endpoint" },
    { id: "ucp-step-bin", title: "3. Add the bin and audit" },
    { id: "ucp-step-dry-run", title: "4. Preview the install" },
    { id: "ucp-step-install", title: "5. Install, verify, uninstall" },
    { id: "ucp-step-verify-endpoint", title: "6. Verify the UCP endpoint itself" },
    { id: "ucp-success", title: "What success looks like" },
