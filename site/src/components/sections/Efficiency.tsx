 ...
 * ~23,000 lines of per-platform integration logic (32 adapters) you would
  ...
  return (
    <Section id="efficiency">
      <SectionHeading
        ...
        description="Supporting agent hosts the old way means hand-authoring and maintaining a different config dialect, install flow, and quirk-set for every one. agent-connector already did that work — across 42 platforms, 6 content/MCP surfaces, and 3 hook paradigms — so your integration collapses to a single definition."
      />
