  ...
  return (
    <Section id="surfaces" className="py-16 sm:py-20">
      <SectionHeading
        ...
        description="agent-connector generalizes context-mode's adapter layer across six integration surfaces — each rendered into the host's native shape, degrading gracefully where a host lacks one. Two runtime-dispatched handler surfaces (statusline, actions) are shown per-host on the wall below, lit only where agent-connector wires them."
      />
