...
![platforms](https://img.shields.io/badge/platforms-32-2563eb)
...
![tests](https://img.shields.io/badge/tests-1807%20passing-22c55e)
...
> Status: **32 platforms, all 3 hook paradigms** (exceeds the
...
> | `mcp-only` (MCP registration only) | Warp · Roo Code · Cline · Trae · Zed · Amp · Codebuff · Mux · Pi |
...
- **1807 tests passing** · `tsc` clean · build green.
...
> 32-adapter registry — there is no "install to all 32 unconditionally" path.
...
[AGENTS.md](https://agents.md) on 29 of the 32 hosts** (the open, Linux
